...
void function() {
  "use strict"; 
  console.log("Trying to run func");

  var f={
    compile: function(r) { 
      return i.template.replace(
        i.pattern, 
        function(t,e){
